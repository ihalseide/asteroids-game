# This file holds the code for the main "play game" state
...
from .. import setup, util
from ..components import particles, asteroid
...
class Game(State):
	...
	def draw_hud(self, screen):
		...
		text_draw.draw_string(screen, text_color, message, (20, 20), (20, 20),
			spacing=.5)
		if self.game_is_over:
			text_draw.draw_string(screen, text_color, "GAME OVER",
	...
	def add_explosion(self, x, y, size, color = (255,255,255)):
		exp = particles.Explosion(x, y, size, self.current_time,
		                          self.rng)
